...
mkdir /opt/martexcoin-v4.0.2
cd /opt/martexcoin-v4.0.2
wget https://github.com/martexcoin/martexcoin/releases/download/v4.0.2.1/martexcore-4.0.2-x86_64-linux-gnu.tar.gz
